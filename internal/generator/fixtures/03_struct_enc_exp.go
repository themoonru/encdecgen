...
func (m *MapScalarIntStruct) EncodeMsgpack(e *msgpack.Encoder) error {
	if err := e.EncodeArrayLen(5); err != nil {
		return fmt.Errorf("error encode struct MapScalarIntStruct to MsgPack: %w", err)
	}
...
func (m *MapScalarIntStruct) DecodeMsgpack(d *msgpack.Decoder) error {
	var err error
	var length int
...
func (m *MapScalarUIntStruct) EncodeMsgpack(e *msgpack.Encoder) error {
	if err := e.EncodeArrayLen(5); err != nil {
		return fmt.Errorf("error encode struct MapScalarUIntStruct to MsgPack: %w", err)
	}
...
func (m *MapScalarUIntStruct) DecodeMsgpack(d *msgpack.Decoder) error {
	var err error
	var length int
	if length, err = d.DecodeArrayLen(); err != nil {
		return err
...
func (m *MapScalarFloatStruct) EncodeMsgpack(e *msgpack.Encoder) error {
	if err := e.EncodeArrayLen(2); err != nil {
		return fmt.Errorf("error encode struct MapScalarFloatStruct to MsgPack: %w", err)
	}
...
func (m *MapScalarFloatStruct) DecodeMsgpack(d *msgpack.Decoder) error {
	var err error
	var length int
	if length, err = d.DecodeArrayLen(); err != nil {
		return err
...
func (m *MapScalarComplexStruct) EncodeMsgpack(e *msgpack.Encoder) error {
	if err := e.EncodeArrayLen(2); err != nil {
		return fmt.Errorf("error encode struct MapScalarComplexStruct to MsgPack: %w", err)
	}
...
func (m *MapScalarComplexStruct) DecodeMsgpack(d *msgpack.Decoder) error {
	var err error
	var length int
	if length, err = d.DecodeArrayLen(); err != nil {
		return err
...
func (m *MapScalarOtherStruct) EncodeMsgpack(e *msgpack.Encoder) error {
	if err := e.EncodeArrayLen(4); err != nil {
		return fmt.Errorf("error encode struct MapScalarOtherStruct to MsgPack: %w", err)
	}
...
func (m *MapScalarOtherStruct) DecodeMsgpack(d *msgpack.Decoder) error {
	var err error
	var length int
	if length, err = d.DecodeArrayLen(); err != nil {
		return err
